    ...
    <footer className="bg-[#EBE7DE] pt-24 pb-12 px-6 text-[#5D5A53]">
      <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-4">
          <h4 className="text-2xl font-serif text-[#2C2A26] mb-6">Shurekate</h4>
      ...
      <div className="max-w-[1800px] mx-auto mt-20 pt-8 border-t border-[#D6D1C7] flex flex-col md:flex-row justify-between items-center text-xs uppercase tracking-widest opacity-60 md:pr-24">
        <div className="flex flex-col md:flex-row gap-4 items-center text-center md:text-left">
          <p>&copy; {new Date().getFullYear()} Shurekate. All rights reserved.</p>
          <span className="hidden md:inline">|</span>
          <a href="mailto:support@shurekate.com" className="hover:text-[#2C2A26] transition-colors lowercase tracking-normal">support@shurekate.com</a>
        </div>
