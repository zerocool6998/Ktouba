      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {JOURNAL_ARTICLES.map((article) => (
                <div key={article.id} className="group cursor-pointer flex flex-col h-full text-left" onClick={() => onArticleClick(article)}>
                    <div className="w-full aspect-[4/3] overflow-hidden mb-8 bg-[#EBE7DE] shrink-0">
                        <img 
                            src={article.image} 
                            alt={article.title} 
                    ...
                    <div className="flex flex-col flex-grow text-left">
                        ...
                        <h3 className="text-2xl font-serif text-[#2C2A26] mb-4 leading-tight group-hover:underline decoration-1 underline-offset-4 line-clamp-2">{article.title}</h3>
